  ...
  return (
    <div className="fixed bottom-8 right-8 z-999">
      <div className="flex items-center gap-2.5">
        <Link href={'/enroll'} className="hidden lg:block bg-purple_blue/80 text-sm hover:bg-purple_blue text-white px-4 py-3.5 leading-none rounded-lg font-medium text-nowrap">
